...
#include "../../threadTest/TimerThread.h"
...
QT_MOC_LITERAL(1, 12, 9), // "sg_tictok"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4) // "time"

    },
    "TimerThread\0sg_tictok\0\0time"
};
...
void TimerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TimerThread::*)(QVariant );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimerThread::sg_tictok)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TimerThread::sg_tictok(QVariant _t1)
{
